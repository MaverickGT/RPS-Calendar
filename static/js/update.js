...
const handleUpdateEvent = () => {
    ...
    fetch(`/api/admin/update/${eventId}`, { method: "PUT", body: JSON.stringify(body), headers: { "Authorization": `Bearer ${jwtToken}`, 'Content-Type': "application/json" } }).then((res) => console.log(res));
