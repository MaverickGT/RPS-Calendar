  ...
  return (
    <>
      <nav className="flex justify-between mb-12 border-b border-green-100 p-4">
        <Image src="/HPE_logo.svg" alt="Hewlett-Packard Enterprise Logo" width={90} height={30} />
        <h1 className="font-bold text-2xl text-gray-700">RPS Event Calendar</h1>
      ...
      <main className="flex min-h-screen flex-col items-center justify-between p-24">
        <div className="grid grid-cols-10">
          ...
          <div id="draggable-el" className="ml-8 w-full border-2 p-2 rounded-md mt-16 lg:h-1/2 bg-green-50">
